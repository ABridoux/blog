...
So even if the adjustable trait is mostly used on sliders and steppers, it can be useful for other controls offering a single selection. Something to keep in mind!